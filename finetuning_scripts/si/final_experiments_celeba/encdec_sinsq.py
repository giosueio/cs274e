...
epochs = 500
si.train(combined_dataloader, optimizer, epochs, scheduler=scheduler,loss_type='velocity', eval_int=50, save_int=50, save_path=f'../finetuning_scripts/models/celeba_model_encdec')
