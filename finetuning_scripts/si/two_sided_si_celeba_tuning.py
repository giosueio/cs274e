...
for lr in lrs:
    ...
    epochs = 100
    si.train(combined_dataloader, optimizer, epochs,loss_type='velocity', scheduler=scheduler, eval_int=5, save_int=10, save_path=f'../finetuning_scripts/celeba_demo_two_sided/encdec_ot_{lr}')
